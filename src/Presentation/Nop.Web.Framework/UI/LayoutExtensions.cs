...
namespace Nop.Web.Framework.UI
{
    ...
    /// </summary>
    /// <remarks>
    /// Ported in task 6.3 (Requirements 4.1, 4.4): <c>System.Web.Mvc.HtmlHelper</c> →
    /// <see cref="IHtmlHelper"/>, <c>UrlHelper</c> → <see cref="IUrlHelper"/>,
    /// <c>MvcHtmlString</c> → <see cref="IHtmlContent"/>. The <c>excludeFromBundle</c> and
    /// <c>bundleFiles</c> parameters are retained but inert — bundling was dropped (design §8).
    /// </remarks>
    public static class LayoutExtensions
    {
        ...
        /// <param name="excludeFromBundle">INERT — bundling was dropped (design §8)</param>
        ...
        /// <param name="location">A location of the script element</param>
        /// <param name="bundleFiles">INERT — bundling was dropped (design §8)</param>
        /// <returns>Generated string</returns>
