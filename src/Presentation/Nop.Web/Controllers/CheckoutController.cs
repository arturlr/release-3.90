...
namespace Nop.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        public virtual IActionResult BillingAddress(Microsoft.AspNetCore.Http.IFormCollection form)
        {
            //validation
            var cart = _workContext.CurrentCustomer.ShoppingCartItems
                .Where(sci => sci.ShoppingCartType == ShoppingCartType.ShoppingCart)
        ...
        public virtual IActionResult NewBillingAddress(CheckoutBillingAddressModel model, Microsoft.AspNetCore.Http.IFormCollection form)
        {
            //validation
            var cart = _workContext.CurrentCustomer.ShoppingCartItems
                .Where(sci => sci.ShoppingCartType == ShoppingCartType.ShoppingCart)
        ...
        public virtual IActionResult NewShippingAddress(CheckoutShippingAddressModel model, Microsoft.AspNetCore.Http.IFormCollection form)
        {
            //validation
            var cart = _workContext.CurrentCustomer.ShoppingCartItems
                .Where(sci => sci.ShoppingCartType == ShoppingCartType.ShoppingCart)
        ...
        public virtual IActionResult PaymentInfo()
        {
                ...
                (paymentMethod.PaymentMethodType == PaymentMethodType.Redirection && _paymentSettings.SkipPaymentInfoStepForRedirectionPaymentMethods))
            {
                ...
                //session save
                // TODO: Use session serialization for OrderPaymentInfo
        ...
        public virtual IActionResult EnterPaymentInfo(Microsoft.AspNetCore.Http.IFormCollection form)
        {
            //validation
            var cart = _workContext.CurrentCustomer.ShoppingCartItems
                .Where(sci => sci.ShoppingCartType == ShoppingCartType.ShoppingCart)
            ...
            var paymentController = EngineContext.Current.Resolve(paymentControllerType) as BasePaymentController;
        ...
        public virtual IActionResult ConfirmOrder()
        {
            ...
            try
            {
                var processPaymentRequest = (ProcessPaymentRequest)null; // TODO: Get OrderPaymentInfo from session
                ...
                {
                    // TODO: Clear OrderPaymentInfo from session
        ...
        public virtual IActionResult OpcSaveBilling(Microsoft.AspNetCore.Http.IFormCollection form)
        {
            try
            {
                //validation
                ...
                else
                {
                    ...
                    // TODO: TryUpdateModelAsync needs async refactoring // TryUpdateModel(model.NewAddress, "BillingNewAddress");
                ...
                if (cart.RequiresShipping())
                {
                    ...
                    var model = new CheckoutBillingAddressModel();
                    // TODO: TryUpdateModelAsync needs async refactoring // TryUpdateModel(model);
        ...
        public virtual IActionResult OpcSaveShipping(Microsoft.AspNetCore.Http.IFormCollection form)
        {
            try
            {
                //validation
                ...
                else
                {
                    //new address
                    var model = new CheckoutShippingAddressModel();
                    // TODO: TryUpdateModelAsync needs async refactoring // TryUpdateModel(model.NewAddress, "ShippingNewAddress");
        ...
        public virtual IActionResult OpcSaveShippingMethod(Microsoft.AspNetCore.Http.IFormCollection form)
        {
            try
            {
                //validation
        ...
        public virtual IActionResult OpcSavePaymentMethod(Microsoft.AspNetCore.Http.IFormCollection form)
        {
            try
            {
                //validation
        ...
        public virtual IActionResult OpcSavePaymentInfo(Microsoft.AspNetCore.Http.IFormCollection form)
        {
            try
            {
                //validation
