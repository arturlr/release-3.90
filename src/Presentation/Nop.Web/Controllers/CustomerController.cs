...
namespace Nop.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        [NonAction]
        protected virtual string ParseCustomCustomerAttributes(Microsoft.AspNetCore.Http.IFormCollection form)
        {
            if (form == null)
        ...
        //available even when navigation is not allowed
        [PublicStoreAllowNavigation(true)]
        public virtual IActionResult Register(RegisterModel model, string returnUrl, bool captchaValid, Microsoft.AspNetCore.Http.IFormCollection form)
        {
            //check whether registration is allowed
            if (_customerSettings.UserRegistrationType == UserRegistrationType.Disabled)
                return RedirectToRoute("RegisterResult", new {resultId = (int) UserRegistrationType.Disabled});
        ...
        public virtual IActionResult Info(CustomerInfoModel model, Microsoft.AspNetCore.Http.IFormCollection form)
        {
            if (!_workContext.CurrentCustomer.IsRegistered())
                return Unauthorized();
        ...
        public virtual IActionResult AddressAdd(CustomerAddressEditModel model, Microsoft.AspNetCore.Http.IFormCollection form)
        {
            if (!_workContext.CurrentCustomer.IsRegistered())
                return Unauthorized();
        ...
        public virtual IActionResult AddressEdit(CustomerAddressEditModel model, int addressId, Microsoft.AspNetCore.Http.IFormCollection form)
        {
            if (!_workContext.CurrentCustomer.IsRegistered())
                return Unauthorized();
        ...
        public virtual IActionResult UploadAvatar(CustomerAvatarModel model, Microsoft.AspNetCore.Http.IFormFile uploadedFile)
        {
            if (!_workContext.CurrentCustomer.IsRegistered())
                return Unauthorized();
        ...
        public virtual IActionResult RemoveAvatar(CustomerAvatarModel model, Microsoft.AspNetCore.Http.IFormFile uploadedFile)
        {
            if (!_workContext.CurrentCustomer.IsRegistered())
                return Unauthorized();
