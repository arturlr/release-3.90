...
namespace Nop.Plugin.Shipping.FixedOrByWeight.Data
{
    ...
    public class ShippingByWeightObjectContext : DbContext, IDbContext
    {
        ...
        public ShippingByWeightObjectContext(string connectionString)
            : base(GetOptions(connectionString))
        {
        }

        private static DbContextOptions<ShippingByWeightObjectContext> GetOptions(string connectionString)
        {
            return new DbContextOptionsBuilder<ShippingByWeightObjectContext>()
        ...
        {
            Database.ExecuteSqlRaw("IF OBJECT_ID('ShippingByWeight', 'U') IS NOT NULL DROP TABLE [ShippingByWeight]");
        }
