    ...
    public class FedexShipmentTracker : IShipmentTracker
    {
        ...
        public virtual IList<ShipmentStatusEvent> GetShipmentEvents(string trackingNumber)
        {
            ...
            catch (HttpRequestException ex)
            {
                ...
                sb.AppendFormat("HttpRequestException Message= {0}.", ex.Message);
                sb.AppendFormat("HttpRequestException Category:Code:Message= {0}.", ex.Message);
                //sb.AppendFormat("HttpRequestException XML String for all= {0}.", ex.Detail.LastChild.OuterXml);
