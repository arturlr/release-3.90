...
namespace Nop.Core.Tests.Domain
{
    ...
    public class EntityEqualityTests
    {
        ...
        public void Two_transient_entities_should_not_be_equal() {
            ...
            Assert.That(p1, Is.Not.EqualTo(p2), "Different transient entities should not be equal");
        }
        ...
        public void Two_references_to_same_transient_entity_should_be_equal() {
            ...
            Assert.That(p1, Is.EqualTo(p2), "Two references to the same transient entity should be equal");
        }
        ...
        public void Two_references_with_the_same_id_should_be_equal() {
            ...
            Assert.That(p1, Is.EqualTo(p2), "Entities with the same id should be equal");
        }
        ...
        public void Entities_with_different_id_should_not_be_equal() {
            ...
            Assert.That(p1, Is.Not.EqualTo(p2), "Entities with different ids should not be equal");
        }
        ...
        public void Entity_should_not_equal_transient_entity() {
            ...
            Assert.That(p1, Is.Not.EqualTo(p2), "Entity and transient entity should not be equal");
        }
