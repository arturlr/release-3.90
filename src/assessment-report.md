# NopCommerce Solution Assessment Report
...
| **Total Projects** | 31 |
| **Total Lines of Code** | 289,804 |
| **Overall Complexity** | Critical |
| **Current Framework** | .NET Framework 4.5.1 (ASP.NET MVC 5) |
| **Target Framework** | net10.0 |
| **Incompatible Packages** | 237 |
| **Non-Upgradeable APIs** | 12,746 |

---

## Executive Summary

The NopCommerce solution is a large e-commerce platform built on ASP.NET MVC 5 with .NET Framework 4.5.1. Migration to net10.0 requires: ASP.NET MVC 5 to ASP.NET Core, EF6 to EF Core, DotNetOpenAuth replacement, RhinoMocks replacement, and OWIN/Katana removal. 27 of 31 projects rated Critical complexity.

---


- **Solution Path**: 54f6bba9-f62f-4670-97f3-477b030d8f5b_extracted/sourceCode/NopCommerce.sln
