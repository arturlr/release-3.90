...
public static class SystemCustomerAttributeNames
{
    ...
    public const string PasswordRecoveryTokenDateGenerated = "PasswordRecoveryTokenDateGenerated";
    public const string AccountActivationToken = "AccountActivationToken";
    public const string EmailRevalidationToken = "EmailRevalidationToken";
    ...
    public const string SelectedPickupPoint = "SelectedPickupPoint";
    ...
    public const string EuCookieLawAccepted = "EuCookieLaw.Accepted";
}
